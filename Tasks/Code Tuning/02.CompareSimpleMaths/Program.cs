...
namespace _02.CompareSimpleMaths
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("{0:F5}", AddingTest.Add(int.MaxValue/2, int.MaxValue/2));
            ...
            Console.WriteLine("{0:F5}", SubtractionTest.Subtract(int.MaxValue / 2, int.MaxValue / 2));
            ...
            Console.WriteLine("{0:F5}", IncrementingTest.Increment(int.MaxValue-1));
            ...
            Console.WriteLine("{0:F5}", MultiplicationTest.Multiply(Math.Sqrt(int.MaxValue), Math.Sqrt(int.MaxValue)));
            ...
            Console.WriteLine("{0:F5}", DivisionTest.Divide(int.MaxValue, int.MaxValue));
